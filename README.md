...
## Day 1
> Note:I generally ***DO NOT*** recommend coding along with lecture, however the code is here if you'd like to do so.
If you'd like the code along you can do the following, otherwise ignore these instructions!
